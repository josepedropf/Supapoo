...
public class PortVerticalBuilder extends LevelElementBuilder {
    public PortVerticalBuilder(Size elementSize) {
        super(elementSize);
    }
    ...
    protected TextImage getTextImage() throws IOException {
        return new LoaderTextImageBuilder("verticalport").createTextImage();
    }
}