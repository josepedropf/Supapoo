...
public class PortDownBuilder extends LevelElementBuilder {
    public PortDownBuilder(Size elementSize) {
        super(elementSize);
    }
    ...
    protected TextImage getTextImage() throws IOException {
        return new LoaderTextImageBuilder("downport").createTextImage();
    }
}
