...
public class WinMenuBuilder extends MenuBuilder {
    public WinMenuBuilder(Size size) {
        super(size);
    }
    ...
    protected List<Title> createTitles() {
        ...
        //Title title = new Title(new Position(size.getWidth() / 2 - 7, size.getHeight() / 2), new Text("YOU WON!!! :)", "#000000", "#22ff22"));
        //Maybe add Level Name or number in the future
        //titles.add(title);
    ...
    protected List<Image> createImages() throws IOException {
        ...
        TextImage titleImage = new LoaderTextImageBuilder("won").createTextImage();
