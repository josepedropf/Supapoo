...
public class PortRightBuilder extends LevelElementBuilder {
    public PortRightBuilder(Size elementSize) {
        super(elementSize);
    }
    ...
    protected TextImage getTextImage() throws IOException {
        return new LoaderTextImageBuilder("rightport").createTextImage();
    }
}
